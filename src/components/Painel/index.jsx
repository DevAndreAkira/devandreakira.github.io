                            ...
                            <div style={{ position: 'relative;' }} className="m-auto">
                                <hgroup role="group" aria-roledescription="Heading group" className='position-relative d-flex flex-column text-white align-items-center'>
                                    ...
                                    <ReactAudioPlayer
                                        ...
                                        controls
                                    />
                                    <h1 className='painel_nome p-0 m-0 mb-1' aria-roledescription={i18n.t('dev.front')}>{i18n.t('dev.front')}</h1>
                                    <h1 className='painel_nome p-0 m-0 mb-4'>{i18n.t('ola.ola')} André Akira</h1>
                                </hgroup>
