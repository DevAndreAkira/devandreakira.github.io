                        ...
                        <div className="collapse navbar-collapse flex-column" id="navbarSupportedContent">
                            <div style={{ position: 'relative;' }} className="m-auto">
                                <div className='position-relative'>
                                    ...
                                    <img src={sazonImages([logoPascoa, logoPascoa, logoBruxo, logoNatal], logo)} alt="DevAndreAkira" width="250" height="250" className="logo" loading="lazy" title="DevAndreAkira" />
